...
var Options = class {
  ...
  addExecutorLzReceiveOption(gas, value = 0) {
    ...
    this.addOption(1 /* Executor */, {
      type: 1 /* lzReceive */,
      params: valueBN.eq(0) ? ethers.utils.solidityPack(["uint128"], [gasBN]) : ethers.utils.solidityPack(["uint128", "uint128"], [gasBN, valueBN])
    });
    return this;
  }
